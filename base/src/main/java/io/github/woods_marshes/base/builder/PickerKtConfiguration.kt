...
import io.github.woods_marshes.base.builder.query.JsonSerializer
...
import io.github.woods_marshes.base.builder.query.where
...
class PickerKtConfiguration internal constructor(
    ...
    var predicate: Expression = where {
        if (!rebuiltAtLeastOnce && mimeTypes.isNotEmpty()) {
